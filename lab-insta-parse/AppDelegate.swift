...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "TBLbDTPYwCpeox8uztEHqrvNbOWncNk8OeCVPmss",
                              clientKey: "hq6fiSAv48VpWmSbyIE9OtgmesipwTbm4cXkyTsC",
                              serverURL: URL(string: "https://parseapi.back4app.com")!)
        
//        let parseConfig = ParseClientConfiguration {
//            $0.applicationId = "TBLbDTPYwCpeox8uztEHqrvNbOWncNk8OeCVPmss"
//            $0.clientKey = "hq6fiSAv48VpWmSbyIE9OtgmesipwTbm4cXkyTsC"
